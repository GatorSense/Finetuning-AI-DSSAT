...
class PreProcessor:
    def __init__(self, test_years=None, max_seq_len=160):
        ...
        self.scale_cols = [
            ...
            'Rain', 'AirTempC', 'SolarRad',
            'NTotal', 'GroStage', 
            'Treatment_0', 'Treatment_1','Treatment_2', 'TuberDW',
            'TuberDW_cumsum', 'tuber_diff_lb', 'tuber_diff_ub'
        ]
        #
    ...
    def prepare_dataset(self, data):
        ...
        pd_features, pd_targets, pd_seq_lens, pd_smnLB, pd_smnUB = self.group_and_pad_scenarios(data)
